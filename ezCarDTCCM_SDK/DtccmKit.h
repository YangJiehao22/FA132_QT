...
namespace dtkit
{
    ...
    DTKIT_EXPORTS void imageDiv(IMAGE_ROI src, IMAGE_ROI dst, int alpha);       // 将原图像除以 alpha 并赋值到目标图像上
    ...
    DTKIT_EXPORTS void bayer2rgbEnhanceRoi(IMAGE_ROI src, IMAGE_ROI dst, BAYER bayer_type); // 边缘清晰插值算法
	...
	DTKIT_EXPORTS void bayer2rgbSharpRoi(IMAGE_ROI src, IMAGE_ROI dst, BAYER bayer_type);	// 根据ROI区域将bayer图像转换成rgb
	...
	DTKIT_EXPORTS void yuv4222rgb32Roi(IMAGE_ROI src, IMAGE_ROI dst, YUV422 yuv422_type);	// 将YUV422转换位rbg
    ...
    DTKIT_EXPORTS void imageSum(IMAGE_ROI src, IMAGE_ROI dst);                          // 将源图像叠加到目标图像上
